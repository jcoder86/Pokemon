...
Een vrolijk, tekstloos verzamelspelletje voor Julian (5 jaar), geïnspireerd op de eerste generatie Pokémon — maar dan in kleur, zonder lezen, zonder verliezen. Alles zit in één bestand: `index.html` (plus het startscherm `start.png`).
...
1. Open **Safari** op de iPad en ga naar de pagina waar het spel wordt gehost (bijv. GitHub Pages: `https://jcoder86.github.io/Pokemon/`).
2. Draai de iPad in **landscape** (liggend).
3. Tik op **START**.

Tip: tik in Safari op de deelknop en kies **"Zet op beginscherm"** — dan start het spel voortaan fullscreen als een app. Na het laden is geen internet meer nodig.

## Assets

- `start.png` — het startscherm-artwork (ook de stijlreferentie voor Julians in-game sprite).
- `assets/julian-avatar.svg` — de avatar van Julian, afgeleid van het aangeleverde source-artwork.
